  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <pre className="bg-gray-100 p-4 rounded text-sm overflow-auto">{JSON.stringify(story, null, 2)}</pre>
      </div>

      <div>
        <h2 className="text-xl mb-2">章节数据:</h2>
        <pre className="bg-gray-100 p-4 rounded text-sm overflow-auto">{JSON.stringify(chapters, null, 2)}</pre>
      </div>
    </div>
  );
}
