...
const zhTranslations: Record<string, string> = {
  ...
  "modal.continue_chapter.new_chapter_fee_desc": "为新章节设置分叉费用",
  "modal.continue_chapter.new_chapter_fee_explanation": "其他用户分叉你的新章节时需要支付的费用",
  ...
  "modal.fork_chapter.fee_explanation": "此费用将支付给原章节作者",
  "modal.fork_chapter.payment_required": "需要支付的费用",
  "modal.fork_chapter.payment_to_author": "支付给原作者",
  "modal.fork_chapter.new_chapter_fee_desc": "为分叉章节设置分叉费用",
  "modal.fork_chapter.new_chapter_fee_explanation": "其他用户分叉你的分叉章节时需要支付的费用",
...
const enTranslations: Record<string, string> = {
  ...
  "story.detail.only_author_can_add_first_chapter": "Only story creator can add the first chapter",
  ...
  "modal.continue_chapter.new_chapter_fee_desc": "Set fork fee for new chapter",
  "modal.continue_chapter.new_chapter_fee_explanation": "Fee required when others fork your new chapter",
  ...
  "modal.fork_chapter.fee_explanation": "This fee will be paid to the original chapter author",
  "modal.fork_chapter.payment_required": "Payment required",
  "modal.fork_chapter.payment_to_author": "Payment to original author",
  "modal.fork_chapter.new_chapter_fee_desc": "Set fork fee for fork chapter",
  "modal.fork_chapter.new_chapter_fee_explanation": "Fee required when others fork your fork chapter",
